...
The application is already deployed as a web app to the cloud as a minimum viable product and ready to use. Click on this link [here](https://aicodeanalyzer.streamlit.app/) to test the app in production.You can try out the app with my demo API key **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** since its a private repo. I can change it later.
